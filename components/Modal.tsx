...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div className="justify-content items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none fous:outline-none bg-neutral-800 bg-opacity-70">
